    ...
    <div className='min-h-screen bg-gray-50'>
      ...
      <div className=' '>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='flex space-x-8'>
            ...
            >
              <FaShoppingCart className={`h-4 w-4 mr-2 ${activeTab === "sell" ? 'text-blue-500' : 'text-gray-400'}`} />
              Sell Bill
            </button>
            ...
            >
              <FaTruck className={`h-4 w-4 mr-2 ${activeTab === "purchase" ? 'text-green-500' : 'text-gray-400'}`} />
              Purchase Bill
            </button>
          </div>
        </div>
      ...
      <div className='max-w-7xl mx-auto  sm:px-6 lg:px-8'>
        <div className='px-4 sm:px-0'>
          {activeTab === "sell" ? <SellBill /> : <PurchaseBill />}
        </div>
      </div>
    </div>
  );
